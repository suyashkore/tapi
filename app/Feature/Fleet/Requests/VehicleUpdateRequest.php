 ...
 *
 * Handles validation for updating an existing vehicle.
 *
...
class VehicleUpdateRequest extends FormRequest
{
    ...
    {
        $vehicleId = $this->route('id'); // Get the vehicle ID from the route parameter

        return [
            'tenant_id' => 'nullable|exists:tenants,id',
            'company_tag' => 'nullable|exists:companies,id',
            'base_office_id' => 'sometimes|required|exists:offices,id',
            ...
            'vehicle_ownership' => 'sometimes|required|string|in:OWN,ATTACHED,MARKET|max:16',
            'make' => 'sometimes|required|string|max:32',
    ...
    {
        Log::error('Validation failed for vehicle update request data in VehicleUpdateRequest', $validator->errors()->toArray());
