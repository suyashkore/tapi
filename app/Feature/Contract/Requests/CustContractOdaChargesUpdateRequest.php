...
/**
 * Class CustContractOdaChargesUpdateRequest
 *
 * Handles validation for updating an existing ODA charge.
 *
 * @package App\Feature\Contract\Requests
 */
class CustContractOdaChargesUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $custContractOdaChargeId = $this->route('id'); // Get the ODA charge ID from the route parameter
    ...
    {
        Log::error('Validation failed for update ODA charge request data in CustContractOdaChargesUpdateRequest', $validator->errors()->toArray());
