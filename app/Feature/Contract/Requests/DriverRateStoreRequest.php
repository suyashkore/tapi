...
/**
 * Class DriverRateStoreRequest
 *
 * @package App\Feature\Contract\Requests
 */
class DriverRateStoreRequest extends FormRequest
{
    /**
    ...
    {
        Log::error('Validation failed for DriverRate store request.', $validator->errors()->toArray());
