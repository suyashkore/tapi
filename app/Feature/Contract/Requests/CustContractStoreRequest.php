...
/**
 * Class CustContractStoreRequest
 *
 * Handles validation for storing a new customer contract.
 *
 * @package App\Feature\Contract\Requests
 */
class CustContractStoreRequest extends FormRequest
{
    /**
    ...
    {
        Log::error('Validation failed for new customer contract request data in CustContractStoreRequest', $validator->errors()->toArray());
