...
/**
 * Class CustContractSlabRateStoreRequest
 *
 * Handles validation for storing a new contract slab rate.
 *
 * @package App\Feature\Contract\Requests
 */
class CustContractSlabRateStoreRequest extends FormRequest
{
    /**
    ...
    {
        Log::error('Validation failed for new contract slab rate request data in CustContractSlabRateStoreRequest', $validator->errors()->toArray());
