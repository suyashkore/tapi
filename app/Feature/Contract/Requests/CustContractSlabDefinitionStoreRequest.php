...
/**
 * Class CustContractSlabDefinitionStoreRequest
 *
 * Handles validation for storing a new CustContractSlabDefinition.
 *
 * @package App\Feature\Contract\Requests
 */
class CustContractSlabDefinitionStoreRequest extends FormRequest
{
    /**
    ...
    {
        Log::error('Validation failed for new CustContractSlabDefinition request data in CustContractSlabDefinitionStoreRequest', $validator->errors()->toArray());
