...
/**
 * Class LoaderRateStoreRequest
 *
 * @package App\Feature\Contract\Requests
 */
class LoaderRateStoreRequest extends FormRequest
{
    /**
    ...
    {
        Log::error('Validation failed for LoaderRate store request.', $validator->errors()->toArray());
