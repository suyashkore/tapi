...
class DriverRateService
{
    ...
    {
        Log::info('Importing DriverRates from xlsx in DriverRateService', ['userContext' => ['userId' => $userContext->userId, 'tenantId' => $userContext->tenantId, 'loginId' => $userContext->loginId]]);
        ...
        try {
            ...
            if (!empty($importResult['errors'])) {
                ...
                Log::error('DriverRates import completed with errors');
            }else{
