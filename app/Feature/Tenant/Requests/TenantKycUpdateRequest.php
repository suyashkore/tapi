...
class TenantKycUpdateRequest extends FormRequest
{
    ...
    {
        $tenantKycId = $this->route('id'); // Get the Tenant KYC ID from the route parameter
    ...
    {
        Log::error('Validation failed for tenant KYC update data in TenantKycUpdateRequest', $validator->errors()->toArray());
