...
class CpKycUpdateRequest extends FormRequest
{
    ...
    {
        $cpKycId = $this->route('id'); // Get the CP KYC ID from the route parameter
    ...
    {
        Log::error('Validation failed for CP KYC update request data in CpKycUpdateRequest', $validator->errors()->toArray());
