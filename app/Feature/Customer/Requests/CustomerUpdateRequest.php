...
class CustomerUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'payment_types' => 'sometimes|nullable|json',
            'industry_type' => 'nullable|string|max:128',
            'c_type' => 'sometimes|nullable|string|in:CONTRACTUAL,RETAIL|max:16',
            ...
            'primary_servicing_office_id' => 'sometimes|nullable|exists:offices,id',
