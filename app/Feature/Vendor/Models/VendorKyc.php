 ...
 * @property string|null $dl_num
 * @property \Illuminate\Support\Carbon|null $dl_issue_date
 * @property \Illuminate\Support\Carbon|null $dl_expiry_date
 * @property string|null $dl_issue_rto
 * @property string|null $dl_card_url
...
class VendorKyc extends Model
{
    ...
    /**
     * Get the tenant that owns the vendor KYC.
     *
    ...
    /**
     * Get the vendor that owns the vendor KYC.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the user who created the vendor KYC.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the user who updated the vendor KYC.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
