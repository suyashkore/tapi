...
class CreateVendorKycTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendor_kyc', function (Blueprint $table) {
            ...
            $table->string('photo1_url', 255)->nullable(); // Owner1 photo URL
            ...
            $table->string('photo2_url', 255)->nullable(); // Owner2 photo URL
            ...
            $table->string('dl_num', 24)->nullable(); // Driving License number
            $table->dateTime('dl_issue_date')->nullable(); // Driving License issue date
            $table->dateTime('dl_expiry_date')->nullable(); // Driving License expiry date
            $table->string('dl_issue_rto', 64)->nullable(); // Driving License issuing RTO
            $table->string('dl_card_url', 255)->nullable(); // Driving License card URL
